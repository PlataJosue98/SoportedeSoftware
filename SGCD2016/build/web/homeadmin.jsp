            ...
            <div class="row">
                <div class="col-sm-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li>
                            <a href="gestionMedicos.jsp">Médicos</a>
                        </li>
                    </ul>
                    <ul class="nav nav-sidebar">                        
                        <li>
                ...
                <div class="col-sm-10 col-sm-offset-2 main">
                    <h1 class="page-header">Administración de Pacientes</h1>
                    <form class="form-horizontal" action="ServletBuscarPaciente" method="POST">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${paciente != null}">
                            ...
                            <form class="form-horizontal" action="ServletActualizarPaciente" method="POST">
                                <div class="form-group">
                                    <label for="inputIdUsuario" class="col-sm-2 control-label">Usuario</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id ="inputIdUsuario" name ="idUsuario" value="${paciente.getId()}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputNombre" class="col-sm-2 control-label">Nombre</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id ="inputNombre" name ="nombreUsuario" value="${paciente.getNombre()}" required>
                                    </div>
                                    <label for="inputPaterno" class="col-sm-2 control-label">Apellido Paterno</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id ="inputPaterno" name ="aPatUsuario" value="${paciente.getApellidoPaterno()}" required>
                                    </div>
                                    <label for="inputMaterno" class="col-sm-2 control-label">Apellido Materno</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id ="inputMaterno" name ="aMatUsuario" value="${paciente.getApellidoMaterno()}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id ="inputDireccion" name ="dirUsuario" value="${paciente.getDireccion()}" placeholder="Dirección:">
                                    </div>
                                </div>
