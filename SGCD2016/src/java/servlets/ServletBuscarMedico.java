...
@WebServlet(name = "ServletBuscarMedico", urlPatterns = {"/ServletBuscarMedico"})
public class ServletBuscarMedico extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                if(!rs.next()){
                    ...
                    sesion.setAttribute("medico",_objUsuario );
                    rd = request.getRequestDispatcher("gestionMedicos.jsp");
                    rd.forward(request, response);
                }
